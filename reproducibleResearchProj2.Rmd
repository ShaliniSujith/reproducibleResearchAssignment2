---
title: "NOAA analysis and its impact"
author: "SHALINI RAVI"
date: "12/3/2020"
...
```
### 2.3 Convert exponent components to actual components

```{r componentNumericConversion}
...
ggplot(damages, aes(x = EVTYPE, y = TOTALDAMAGE)) +
  geom_bar(stat = "identity", fill="orange")+
  theme(axis.text.x = element_text(angle=90, hjust = 1))+
  xlab("Event Type") + ylab("Damage ($)") + ggtitle("Property & Crop damage caused by top 10 weather events")
